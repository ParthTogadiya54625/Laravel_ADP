    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">New Publisher</h4>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="form-control">
                                    <option value="{{config('constants.user.status_code.active')}}" {{ old('status')== '1' ? 'selected' : '' }}>Active</option>
                                    <option value="{{config('constants.user.status_code.inactive')}}" {{ old('status')== '0' ? 'selected' : '' }}>Inactive</option>
                                </select>
                            ...
                            <div>
                                <img src="{{ asset('assets/images/users/avatar5.png') }}" id="output" style="height:120px; width:120px; "/>
                            </div>
                        </div>
